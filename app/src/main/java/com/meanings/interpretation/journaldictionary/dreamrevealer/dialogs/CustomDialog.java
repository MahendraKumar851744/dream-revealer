package com.meanings.interpretation.journaldictionary.dreamrevealer.dialogs;
...
import com.meanings.interpretation.journaldictionary.dreamrevealer.Activities.Ask_Dream;
...
public class CustomDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv7.setOnClickListener(view -> {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT, "Download Dream Revealer app today and start your journey to deeper self-awareness: https://play.google.com/store/apps/details?id=" + getContext().getPackageName());
