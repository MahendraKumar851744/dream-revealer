...
import com.dream.insights.meanings.interpretation.Adapters.Ad_Healing_Sounds;
...
import com.dream.insights.meanings.interpretation.viewModel.HealingViewModel;
...
//        mobileAds.loadBannerAd(findViewById(R.id.adView3));
    ...
    private void setBannerAd(){
        new Utils(this).setBannerAd(findViewById(R.id.bannerplacer),13);
    }
}